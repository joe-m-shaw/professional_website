...
I specialise in making new tests for clinical genetic laboratories. This page lists the lab tests I have developed so far in my career, starting with the most recent. All of these projects were collaborations with many wonderful colleagues who I am greatly indebted to.

# Genomic Instability Testing for Ovarian Cancer

This was a project to validate a new bioinformatics pipeline for detection of genomic instability in ovarian cancer, which was developed by the company [SeqOne Genomics](https://seqone.com/). Accurate detection of genomic instability is necessary for identifying optimum-responders to the anti-cancer drug olaparib (Lynparza®). Until this project, samples were shipped from Manchester to the USA for testing by Myriad Genetics.
...
Spinocerebellar Ataxia type 36 ([SCA36](https://pubmed.ncbi.nlm.nih.gov/25593102/)) is a very rare neurological disorder caused by a hexanucleotide repeat expansion in the *NOP56* gene, with fewer than 200 patients reported in the literature. To my knowledge, no diagnostic service existed in the world prior to this project. 
...
*RFC1*-disorder is a neurological disorder caused by repeat expansions in the *RFC1* gene, and was first [reported in 2019](https://pubmed.ncbi.nlm.nih.gov/30926972/) by Dr Andrea Cortese's research group at the UCLH Institute for Neurology. For this project we developed a diagnostic service for *RFC1* expansions by modifying the available research protocol, and we successfully added *RFC1* testing to the [NHS National Genomic Test Directory](https://www.england.nhs.uk/publication/national-genomic-test-directories/).
